...
<div class="container" style="width:500px;  height: 700px;  border: solid #8ab9e0;">
 ...
 <button onclick="document.getElementById('id01').style.display='block'" 
      ...
      <img id="content-img"  src="./resources/images/sexybeach.jpg" style="background-position:center; background-size:cover; width: 100%;height: 322px; ;"class="img-responsive" >
