...
<html lang="en" class=" js cssanimations" style="height: 100%;"><head>
    ...
    <link type="text/css" rel="stylesheet" href="${context}/resources/css/bootstrap.min.css">
       ...
       <link type="text/css" rel="stylesheet" href="${context}/resources/css/colorbox.css">
        ...
        <link type="text/css" rel="stylesheet" href="${context}/resources/css/form5-tabs.css">
         <link href="${context}/resources/css/jquerysctipttop.css" rel="stylesheet" type="text/css">
...
</script><script type="text/javascript" src="${context}/resources/f.txt"></script>
           ...
           <nav class="menu" style=" top: 0px; bottom: 0px;">
                ...
                <div class="icon-list" style="height: 100%; width: 104%; margin-left: -10px;padding-left: 0px;">
                    <a class="de1" href="${context}/indexpage">
                        <i class="fa fa-fw">
                            <img class="img-responsive" src="${context}/resources/images/home.png" alt="">
...
<div class="<%=str%>">
	 <div class="controlling-col-xs-4">
				...
				<%--  <a class="mydwn" href="${context}/Subscribe/bp=${bp}/publisher=${publisher}"> --%>
				 <a class="mydwn" href="../videopanelplayer/cnt_Id=${list.cnt_id}">
				...
				<a class="mydwn" href="../videopanelplayer/cnt_Id=${list.cnt_id}">
				  ...
				  <%-- <a class="mydwn" href="${context}/Subscriberdetail/bp=${od}/publisher=${pbl}">    --%>
				</c:otherwise>
				</c:choose>
					<%-- <img class="img-responsive"   style="position: absolute !important;padding: 25% 45% 25% 45% !important;" src="${context}/resources/images/play-icon.png" alt=".."> </a>--%>
...
<div class="col-xs-12 over   mid-col over animated slideInUp">
	 <div class="controlling-col-xs-4"  data-contentid="28459502">
                  <c:choose>
                  <c:when test="${status=='true'}">
                				<a class="mydwn" href="../videopanelplayer/cnt_Id=${list.cnt_id}">
				</c:when>
...
<% }%>
			...
			<!-- <div class="col-xs-6 over left-col animated slideInLeft">		
		
		<div class="controlling-col-xs-6-play-vieo"> 
					<a class="mydwn" href="./videopanelplayer/5"> 
					<img class="img-responsive" src="${context}/resources/images/play-icon.png" alt=".."></a>
                </div>            <div class="thumb" style="width: 100%; position: relative;z-index: 100;" data-contentid="28459502">
                
                                    <a class="mydwn" href="./videopanelplayer/5">
                        <img class="img-responsive" src="${context}/resources/images/MIKEHOPKINSSYRACUSEUNIVERSITYPart6_420x280.jpg" alt="..">
                    </a>
                
            </div>
            <div class="controlling-col-xs-6" data-contentid="28459502" data-content_type="Video" data-file_type_id="1" data-file_sub_type_id="352">
                <a class="hyperLinks-style" style="background-image: url(&#39;images/videoIcon.png&#39;);" href="portaldownload.html">
                    <span class="fontsStyle">
                       MIKEHOPKINSSYRACUSEUNIVERSITYPart6_420x280             </span> 
                </a>
                                    <a class="download_icon" href="portaldownload.html"> 
                        <img style="float: right; width: 18px;" src="${context}/resources/images/dwonload.png" alt="..">
                    </a>
            </div>
		
        </div>
			<div class="col-xs-6 right-col over animated slideInRight">		
		
		<div class="controlling-col-xs-6-play-vieo"> 
					<a class="mydwn" href="./videopanelplayer/6"> 
					<img class="img-responsive" src="${context}/resources/images/play-icon.png" alt=".."></a>
                </div>            <div class="thumb" style="width: 100%; position: relative;z-index: 100;" data-contentid="28459502">
                
                                    <a class="mydwn" href="./videopanelplayer/6">
                        <img class="img-responsive" src="${context}/resources/images/MIKEHOPKINSSYRACUSEUNIVERSITYPart7_420x280.jpg" alt="..">
                    </a>
            ...
            <div class="controlling-col-xs-6" data-contentid="28459502" data-content_type="Video" data-file_type_id="1" data-file_sub_type_id="352">
                <a class="hyperLinks-style" style="background-image: url(&#39;images/videoIcon.png&#39;);" href="">
                    <span class="fontsStyle">
                        MIKEHOPKINSSYRACUSEUNIVERSITYPart7_420x280                 </span> 
                </a>
                                    <a class="download_icon" href="portaldownload.html"> 
                        <img style="float: right; width: 18px;" src="${context}/resources/images/dwonload.png" alt="..">
                    </a>
			...
			<div class="col-xs-12 mid-col over animated slideInUp">		
		
		<div class="controlling-col-xs-6-play-vieo"> 
					<a class="mydwn" href="./videopanelplayer/7"> 
					<img class="img-responsive" src="${context}/resources/images/play-icon.png" alt=".."></a>
                </div>            <div class="thumb" style="width: 100%; position: relative;z-index: 100;" data-contentid="28459502">
                
                                    <a class="mydwn" href="./videopanelplayer/7">
                        <img class="img-responsive" src="${context}/resources/images/MIKEHOPKINSSYRACUSEUNIVERSITYPart8_420x280.jpg" alt="..">
                    </a>
            ...
            <div class="controlling-col-xs-6" data-contentid="28459502" data-content_type="Video" data-file_type_id="1" data-file_sub_type_id="352">
                <a class="hyperLinks-style" style="background-image: url(&#39;images/videoIcon.png&#39;);" href="">
                    <span class="fontsStyle">
                       MIKEHOPKINSSYRACUSEUNIVERSITYPart8_420x280                  </span> 
                </a>
                                    <a class="download_icon" href="portaldownload.html"> 
                        <img style="float: right; width: 18px;" src="${context}/resources/images/dwonload.png" alt="..">
                    </a>
		...
		<div class="controlling-col-xs-6-play-vieo"> 
					<a class="mydwn" href="portaldownload.html"> 
					<img class="img-responsive" src="${context}/resources/images/play-icon.png" alt=".."></a>
                </div>            <div class="thumb" style="width: 100%; position: relative;z-index: 100;" data-contentid="28459502">
                
                                    <a class="mydwn" href="portaldownload.html">
                        <img class="img-responsive" src="${context}/resources/images/30009.jpg" alt="..">
                    </a>
		...
		<div class="controlling-col-xs-6-play-vieo"> 
					...
					<img class="img-responsive" src="${context}/resources/images/play-icon.png" alt=".."></a>
                                    ...
                                    <a class="mydwn" href="portaldownload.html">
                        <img class="img-responsive" src="${context}/resources/images/30025.jpg" alt="..">
                    </a>
		...
		<div class="controlling-col-xs-6-play-vieo"> 
					...
					<img class="img-responsive" src="${context}/resources/images/play-icon.png" alt=".."></a>
                                    ...
                                    <a class="mydwn" href="portaldownload.html">
                        <img class="img-responsive" src="${context}/resources/images/30001.jpg" alt="..">
                    </a>
		...
		<div class="controlling-col-xs-6-play-vieo"> 
					...
					<img class="img-responsive" src="${context}/resources/images/play-icon.png" alt=".."></a>
                                    ...
                                    <a class="mydwn" href="portaldownload.html">
                        <img class="img-responsive" src="${context}/resources/images/30282.jpg" alt="..">
                    </a>
		...
		<div class="controlling-col-xs-6-play-vieo"> 
					...
					<img class="img-responsive" src="${context}/resources/images/play-icon.png" alt=".."></a>
                                    ...
                                    <a class="mydwn" href="portaldownload.html">
                        <img class="img-responsive" src="${context}/resources/images/30008.jpg" alt="..">
                    </a>
		...
		<div class="controlling-col-xs-6-play-vieo"> 
					...
					<img class="img-responsive" src="${context}/resources/images/play-icon.png" alt=".."></a>
                                    ...
                                    <a class="mydwn" href="portaldownload.html">
                        <img class="img-responsive" src="${context}/resources/images/30277.jpg" alt="..">
                    </a>
		...
		<div class="controlling-col-xs-6-play-vieo"> 
					...
					<img class="img-responsive" src="${context}/resources/images/play-icon.png" alt=".."></a>
                                    ...
                                    <a class="mydwn" href="portaldownload.html">
                        <img class="img-responsive" src="${context}/resources/images/30017.jpg" alt="..">
                    </a>
                
            </div>
            <div class="controlling-col-xs-6" data-contentid="28459502" data-content_type="Video" data-file_type_id="1" data-file_sub_type_id="352">
                <a class="hyperLinks-style" style="background-image: url(&#39;images/videoIcon.png&#39;);" href="http://q.mobilart.in/index.php#">
                    <span class="fontsStyle">
                        ArabicMake                   </span> 
                </a>
                                    <a class="download_icon" href="portaldownload.html"> 
		...
		<div class="controlling-col-xs-6-play-vieo"> 
					...
					<img class="img-responsive" src="${context}/resources/images/play-icon.png" alt=".."></a>
                                    ...
                                    <a class="mydwn" href="portaldownload.html">
                        <img class="img-responsive" src="${context}/resources/images/30281.jpg" alt="..">
                    </a>
		...
		<div class="controlling-col-xs-6-play-vieo"> 
					...
					<img class="img-responsive" src="${context}/resources/images/play-icon.png" alt=".."></a>
                                    ...
                                    <a class="mydwn" href="portaldownload.html">
                        <img class="img-responsive" src="${context}/resources/images/30284.jpg" alt="..">
                    </a>
		...
		<div class="controlling-col-xs-6-play-vieo"> 
					...
					<img class="img-responsive" src="${context}/resources/images/play-icon.png" alt=".."></a>
                                    ...
                                    <a class="mydwn" href="portaldownload.html">
                        <img class="img-responsive" src="${context}/resources/images/30024.jpg" alt="..">
                    </a>
		...
		<div class="controlling-col-xs-6-play-vieo"> 
					...
					<img class="img-responsive" src="${context}/resources/images/play-icon.png" alt=".."></a>
                                    ...
                                    <a class="mydwn" href="portaldownload.html">
                        <img class="img-responsive" src="${context}/resources/images/29998.jpg" alt="..">
                    </a>
